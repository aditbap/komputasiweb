                    ...
                    <div class="col-12">
                        <nav class="main-nav">
                            ...
                            <ul class="nav">
                                ...
                                <li class="scroll-to-section"><a href="<?php echo e(route('articles.index')); ?>">Artikel</a></li>
                                <li class="scroll-to-section"><a href="<?php echo e(route('auth.login')); ?>">Admin</a></li>
                            </ul>
                            <!-- ***** Menu End ***** -->
                        </nav>
                    </div>
...
</html><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Admin-FreshyFish/resources/views/welcome.blade.php ENDPATH**/ ?>