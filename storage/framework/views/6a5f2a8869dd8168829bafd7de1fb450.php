...
<nav class="navbar navbar-expand-lg navbar-light fixed-top" style="background-color: #0096c8;">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas shadow" id="sidebar">
                <ul class="nav">
                    <!-- Dashboard Menu Item -->
                    <li class="nav-item <?php if(request()->is('dashboard*')): ?> active <?php endif; ?> shadow-sm">
                    ...
                    <!-- Toko Menu Item -->
                    <li class="nav-item <?php if(request()->is('toko*')): ?> active <?php endif; ?> shadow-sm">
                    ...
                    <!-- Produk Menu Item -->
                    <li class="nav-item <?php if(request()->is('produk*')): ?> active <?php endif; ?> shadow-sm">
                    ...
                    <!-- Pesanan Menu Item -->
                    <li class="nav-item <?php if(request()->is('pesanan*')): ?> active <?php endif; ?> shadow-sm">
                        ...
                        <div class="card shadow-lg">
                            <div class="card-body">
                                ...
                                <form id="editStoreForm" class="forms-sample" method="POST" action="#" enctype="multipart/form-data">
                                    ...
                                    <a href="<?php echo e(route('toko.index')); ?>" id="cancelButton" class="btn btn-inverse-dark btn-fw shadow" style="display:none;">Cancel</a>
                                </form>
                            </div>
                        </div>
                    </div>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/Admin-FreshyFish/resources/views/toko/index.blade.php ENDPATH**/ ?>